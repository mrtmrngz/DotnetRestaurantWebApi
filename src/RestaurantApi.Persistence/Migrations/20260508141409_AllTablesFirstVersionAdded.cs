        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Neighborhood = table.Column<string>(type: "character varying(70)", maxLength: 70, nullable: false),
                    Street = table.Column<string>(type: "character varying(85)", maxLength: 85, nullable: false),
                    BuildingInfo = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    BuildingNumber = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_carts_restaurant_tables_RestaurantTableId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderStatus = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_orders_restaurant_tables_RestaurantTableId",
                        column: x => x.RestaurantTableId,
                        principalTable: "restaurant_tables",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Note = table.Column<string>(type: "character varying(350)", maxLength: 350, nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_reservations_restaurant_tables_RestaurantTableId",
                        column: x => x.RestaurantTableId,
                        principalTable: "restaurant_tables",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_product_media_media_MediaId",
                        column: x => x.MediaId,
                        principalTable: "media",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_carts_RestaurantTableId",
                table: "carts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_discounts_ProductId_IsActive",
                table: "discounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_product_media_ProductId_MediaId",
                table: "product_media",
