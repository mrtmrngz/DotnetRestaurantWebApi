...
public class ForgotPasswordApplyRequestExample: IExamplesProvider<ForgotPasswordApplyCommand>
{
    public ForgotPasswordApplyCommand GetExamples()
    {
        return new ForgotPasswordApplyCommand(
            Token: 
