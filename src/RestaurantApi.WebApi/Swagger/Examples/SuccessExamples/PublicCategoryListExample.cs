...
public class PublicCategoryListExample: IExamplesProvider<GeneralSuccessResponseWithData<IReadOnlyList<GetCategoriesQueryResult>>>
{
    public GeneralSuccessResponseWithData<IReadOnlyList<GetCategoriesQueryResult>> GetExamples()
    {
